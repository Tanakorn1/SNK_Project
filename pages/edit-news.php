            ...
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control" required value="<?php echo $row['title']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="picture">รูปเดิม:</label><br>
                        <img src="<?php echo $imageURL; ?>" alt="" style="padding: 10px; width: 255px; height: 180px;" class="card-img-top news-image">
